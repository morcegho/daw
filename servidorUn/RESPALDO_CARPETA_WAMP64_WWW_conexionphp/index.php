...
<body>
  ...
  <li>
    ...
    <li>
      ...
      <input type="text" id="primeiro_apelido" name="user_primeiro_apelido" />
    </li>
    <li>
      <label for="segundo_apelido">2º apelido:</label>
      <input type="text" id="segundo_apelido" name="user_segundo_apelido" />
    </li>
    <li>
      <label for="enderezo">Enderezo:</label>
      <input type="text" id="enderezo" name="user_enderezo" />
    </li>
    <li>
    ...
    <li>
      ...
      <input type="text" id="nacemento" name="user_nacemento" />
    </li>
    <li>
    ...
    <li>
      ...
      <input type="text" id="dgfdgd" name="user_fdgfdgdg" />
    </li>        <li><a href="#">Buscar por nome</a></li>
